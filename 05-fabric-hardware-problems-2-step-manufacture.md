...
![Метод Чохральского](https://ru.dsisolar.com/Content/uploads/2021377093/20210330121440d8e0d9f9cf6b4b938edbc7c505770860.jpg)
   ...
   **Цель:** Получение высокочистого кремниевого монокристалла — основы для всей микросхемной технологии.

    **Процесс:**
- Поликристаллический кремний расплавляется при ~1414°C.
- Затравочный кристалл погружается в расплав и медленно вытягивается с вращением.
- Формируется цилиндрический слиток (буль) диаметром до 300 мм.

**Требования:**
- Исключительно высокая чистота (менее 1 атома примеси на миллиард).
- Низкая плотность дефектов — ключ к высокой производительности микросхем.



---

## Этап 2: Резка на пластины (вафли)

**Цель:** Превратить слиток в тонкие кремниевые пластины.

**Метод:**
- Используются алмазные пилы для точной резки.
- Толщина: 0.5–1 мм; диаметр до 300 мм.
- Возможна последующая эпитаксиальная обработка.

**Контроль:** Каждая пластина проходит визуальный и структурный контроль качества.

---

## Этап 3: Полировка и очистка

**Цель:** Обеспечить ультрагладкую и чистую поверхность перед нанесением структур.

**Процедуры:**
- Механическая и химическая полировка до зеркального блеска.
- Очистка в условиях сверхчистых помещений (ISO 1–3).
- Используются деионизированная вода, ультразвук, азотная сушка.

---

## Этап 4: Фотолитография

**Цель:** Перенос микроструктурных шаблонов на поверхность пластины.

**Основные шаги:**
1. **Окисление:** Формирование тонкого слоя SiO₂.
2. **Нанесение фоторезиста:** Тонкий слой чувствительного полимера.
3. **Экспонирование:** УФ-облучение через фотошаблон.
4. **Проявление:** Удаление облученных или не облученных областей.
5. **Травление:** Селективное удаление материала.
6. **Удаление фоторезиста:** Плазменная очистка или растворение.

---

## Этап 5: Ионная имплантация

**Цель:** Внедрение легирующих элементов для изменения электропроводности.

**Подробности:**
- Используются ионы бора (p-тип) или фосфора (n-тип).
- Глубина и концентрация регулируются энергией и дозой ионов.
- После имплантации — термический отжиг при ~1000°C (15–30 минут) для восстановления кристаллической решетки.

---

## Этап 6: Металлизация

**Цель:** Создание электрических межсоединений между компонентами.

**Процесс:**
- Нанесение диэлектрического слоя (обычно SiO₂).
- Формирование контактных отверстий (vias).
- Осаждение металлов (Al, Cu, W) с последующей фотолитографией и травлением.
- Многослойное повторение процесса.

**Критически важно:** Надежность проводников, отсутствие коротких замыканий и обрывов.

---

## Этап 7: Планаризация (выравнивание поверхности)

**Цель:** Обеспечить идеально плоскую поверхность перед нанесением следующего слоя.

**Метод:** Химико-механическая полировка (CMP)

- Используется суспензия с микрочастицами (например, SiO₂) и механическое давление.
- Удаляются выступы и излишки материала.

**Результат:** Повышается точность фотолитографии и надёжность многослойных соединений.
